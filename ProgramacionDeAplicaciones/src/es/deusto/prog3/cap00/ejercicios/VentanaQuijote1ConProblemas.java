 ...
 */
public class VentanaQuijote1ConProblemas extends JFrame {
	...
	public VentanaQuijote1ConProblemas() {
...
//					listaHilosScroll.add( this );
	...
	private void cargaQuijote() {
		try {
			Scanner scanner = new Scanner( VentanaQuijote1ConProblemas.class.getResourceAsStream( "DonQuijote.txt" ), "UTF-8" );
	...
	public static void main(String[] args) {
		VentanaQuijote1ConProblemas v = new VentanaQuijote1ConProblemas();
		v.setVisible( true );
		v.cargaQuijote();
	}
